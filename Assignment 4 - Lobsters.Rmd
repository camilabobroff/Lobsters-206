...
trap_year <- lob_trap %>% 
  filter( SITE != "CARP", SITE != "MOHK", SITE != "ABUR", SITE != "GOLB", SITE != "AHND to AQUE") %>% 
  group_by(YEAR, SITE) %>%
  summarize(
